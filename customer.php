              ...
              if(mysqli_num_rows($result)>0){
                ...
                ?>
                    ...
                    <tr>
                      ...
                      <td><button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal<?php echo $row['srno'];?>">View</button></td>
                    </tr>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-body">
                            ...
                            <?php echo '<a href="transfer.php?id='.$row['srno'].'">';?>
                            <div class="col-md-12 text-center">
                            <button class="btn btn-success btn-sm">Transfer</button></a>
